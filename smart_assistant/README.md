...
**الإعدادات** قايمة بتتنقل فيها بالكيبورد زي قوايم الطرفية:
`↑ ↓` للتنقل، `Enter` للتغيير، `Esc` للخروج. منها بتحط مفاتيح
المزوّدين، وتشغّل الوضع العميق أو "محلي بس"، وتبدّل الثيم واللغة.
